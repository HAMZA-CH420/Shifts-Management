        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              const SizedBox(height: 30,),
              CustomTextfield(labelText: "Email", controller: emailController,suffixText: "verified",),
              const SizedBox(height: 30,),
              CustomTextfield(labelText: "Phone Number", controller: numberController),
              const SizedBox(height: 30,),
              CustomTextfield(labelText: "Address(optional)", controller: addressController),
              const SizedBox(height: 25,),
              CustomButton(btnColor: Palate.primaryColor, onTap: (){},btnName: "update",)
            ],
          ),
        ),
      ),
